...
package com.luditeam.cordova.plugin.ad.chartboost;
...
class Util {
	...
	public class ChartboostPlugin extends CordovaPlugin {
		private static final String LOG_TAG = "LtChartboostPlugin";
		...
		private void _setUp(String appId, String appSignature) {
			...
			Chartboost.setDelegate(new LtChartboostDelegate());
		}
		...
		class LtChartboostDelegate extends ChartboostDelegate {
